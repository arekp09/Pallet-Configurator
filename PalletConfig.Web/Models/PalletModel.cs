...
namespace PalletConfig.Web.Models
{
    public class PalletModel
    {
        ...
        [Required(ErrorMessage = "Field need to be filled in")]
        [Range(1, 1000, ErrorMessage = "Pallet size need to be between {1} and {2}")]
        ...
        [Required(ErrorMessage = "Field need to be filled in")]
        [Range(0.1, 50, ErrorMessage = "Pallet size need to be between {1} and {2}")]
        public double BoxWeight { get; set; }

        [Required(ErrorMessage = "Field need to be filled in")]
        [Range(20, 1000, ErrorMessage = "Pallet size need to be between {1} and {2}")]
        public int PalletHeight { get; set; }

        [Required(ErrorMessage = "Field need to be filled in")]
        [Range(10, 5000, ErrorMessage = "Pallet size need to be between {1} and {2}")]
